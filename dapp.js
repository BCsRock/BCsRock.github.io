...
async function getStakingGenesis() {
  ...
  try {
    ...
    console.log("Staking genesis could not be retrieved. Check availability of Staking Factory.");
    console.log(err);

    start = "No start available at Liquidity Mining."
    return start;
  }
...
async function getPhaseIEnd() {
  ...
  try {
    ...
    console.log("Staking end Phase I could not be retrieved. Check availability of Staking Rewards.");
    console.log(err);

    start = "No end available."
    return start;
  }
...
async function getPhaseIIEnd() {
  ...
  try {
    ...
    console.log("Staking end Phase II could not be retrieved. Check availability of Staking Rewards.");
    console.log(err);
...
async function getLOTETHBalance() {
  ...
  try {
    ...
    return balance;
      ...
      console.log("An error happened when trying to get ETH/LOT balance. Error: ", err);
      return balance;
  }
...
async function getLOTETHLPlocked() {
  ...
  try {
    ...
    function(error) {
      console.log("An error happened when trying to get LOT/ETH locked balance. Error: ", error);
    });
    ...
    console.log("An error happened when trying to get LOT/ETH locked balance. Error: ", err);
    return balance;
  }
